...
pub use windows::Win32::UI::{
    Controls::{HOTKEYF_ALT, HOTKEYF_CONTROL, HOTKEYF_EXT, HOTKEYF_SHIFT},
    Input::{
        Ime::{
        ...
        KeyboardAndMouse::{
            ...
            VK_FINAL, VK_FPARAM, VK_G, VK_GAMEPAD_A, VK_GAMEPAD_B, VK_GAMEPAD_DPAD_DOWN,
 ...
 * `key` 虚拟键常亮。
 * */
pub fn get_async_key_state(key: VIRTUAL_KEY) -> (bool, bool) {
 ...
 * `key` 虚拟键常亮。
 * */
pub fn get_key_state(key: VIRTUAL_KEY) -> (bool, bool) {
