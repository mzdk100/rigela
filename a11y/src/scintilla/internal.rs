...
pub use scintilla_sys::{
    ...
    SCI_DELWORDRIGHTEND, SCI_DESCRIBEKEYWORDSETS, SCI_DESCRIBEPROPERTY, SCI_DOCUMENTEND,
    ...
    SCI_ENSUREVISIBLE, SCI_ENSUREVISIBLEENFORCEPOLICY, SCI_EXPANDCHILDREN, SCI_FINDCOLUMN,
    SCI_FINDINDICATORFLASH, SCI_FINDINDICATORHIDE, SCI_FINDINDICATORSHOW, SCI_FINDTEXT,
    SCI_FOLDALL, SCI_FOLDCHILDREN, SCI_FOLDDISPLAYTEXTSETSTYLE, SCI_FOLDLINE, SCI_FORMATRANGE,
    SCI_FORMFEED, SCI_GETACCESSIBILITY, SCI_GETADDITIONALCARETFORE, SCI_GETADDITIONALCARETSBLINK,
    ...
    SCI_GETOVERTYPE, SCI_GETPASTECONVERTENDINGS, SCI_GETPHASESDRAW, SCI_GETPOSITIONCACHE,
    SCI_GETPRINTCOLOURMODE, SCI_GETPRINTMAGNIFICATION, SCI_GETPRINTWRAPMODE, SCI_GETPROPERTY,
    SCI_GETPROPERTYEXPANDED, SCI_GETPROPERTYINT, SCI_GETPUNCTUATIONCHARS, SCI_GETRANGEPOINTER,
    ...
    SCI_MULTIEDGECLEARALL, SCI_MULTIPLESELECTADDEACH, SCI_MULTIPLESELECTADDNEXT, SCI_NEWLINE,
    ...
    SCI_PROPERTYNAMES, SCI_PROPERTYTYPE, SCI_REDO, SCI_REGISTERIMAGE, SCI_REGISTERRGBAIMAGE,
    SCI_RELEASEALLEXTENDEDSTYLES, SCI_RELEASEDOCUMENT, SCI_REPLACESEL, SCI_REPLACETARGET,
    SCI_REPLACETARGETRE, SCI_RGBAIMAGESETHEIGHT, SCI_RGBAIMAGESETSCALE, SCI_RGBAIMAGESETWIDTH,
    SCI_ROTATESELECTION, SCI_SCROLLCARET, SCI_SCROLLRANGE, SCI_SCROLLTOEND, SCI_SCROLLTOSTART,
    SCI_SEARCHANCHOR, SCI_SEARCHINTARGET, SCI_SEARCHNEXT, SCI_SEARCHPREV, SCI_SELECTALL,
    SCI_SELECTIONDUPLICATE, SCI_SELECTIONISRECTANGLE, SCI_SETACCESSIBILITY,
    ...
    SCI_SETINDENTATIONGUIDES, SCI_SETINDICATORCURRENT, SCI_SETINDICATORVALUE, SCI_SETKEYWORDS,
    SCI_SETLAYOUTCACHE, SCI_SETLENGTHFORENCODE, SCI_SETLINEENDTYPESALLOWED, SCI_SETLINEINDENTATION,
    SCI_SETLINESTATE, SCI_SETMAINSELECTION, SCI_SETMARGINBACKN, SCI_SETMARGINCURSORN,
    SCI_SETMARGINLEFT, SCI_SETMARGINMASKN, SCI_SETMARGINOPTIONS, SCI_SETMARGINRIGHT,
    SCI_SETMARGINS, SCI_SETMARGINSENSITIVEN, SCI_SETMARGINTYPEN, SCI_SETMARGINWIDTHN,
    SCI_SETMOUSEDOWNCAPTURES, SCI_SETMOUSESELECTIONRECTANGULARSWITCH, SCI_SETMOUSEWHEELCAPTURES,
    SCI_SETMULTIPASTE, SCI_SETMULTIPLESELECTION, SCI_SETOVERTYPE, SCI_SETPASTECONVERTENDINGS,
    SCI_SETPHASESDRAW, SCI_SETPOSITIONCACHE, SCI_SETPRINTCOLOURMODE, SCI_SETPRINTMAGNIFICATION,
    SCI_SETPRINTWRAPMODE, SCI_SETPROPERTY, SCI_SETPUNCTUATIONCHARS, SCI_SETREADONLY,
...
use crate::scintilla::typing::PropertyType;
use crate::scintilla::{
