...
pub use scintilla_sys::{
    ...
    SCI_COPYRANGE, SCI_COPYTEXT, SCI_COUNTCHARACTERS, SCI_CREATEDOCUMENT, SCI_CREATELOADER,
    SCI_CUT, SCI_DELETEBACK, SCI_DELETEBACKNOTLINE, SCI_DELETERANGE, SCI_DELLINELEFT,
    SCI_DELLINERIGHT, SCI_DELWORDLEFT, SCI_DELWORDRIGHT, SCI_DELWORDRIGHTEND, SCI_DOCUMENTEND,
    SCI_DOCUMENTENDEXTEND, SCI_DOCUMENTSTART, SCI_DOCUMENTSTARTEXTEND, SCI_DROPSELECTIONN,
    SCI_EDITTOGGLEOVERTYPE, SCI_EMPTYUNDOBUFFER, SCI_ENCODEDFROMUTF8, SCI_ENDUNDOACTION,
    SCI_FINDCOLUMN, SCI_FINDINDICATORFLASH, SCI_FINDINDICATORHIDE, SCI_FINDINDICATORSHOW,
    SCI_FINDTEXT, SCI_FORMATRANGE, SCI_FORMFEED, SCI_GETADDITIONALCARETFORE,
    SCI_GETADDITIONALCARETSBLINK, SCI_GETADDITIONALCARETSVISIBLE, SCI_GETADDITIONALSELALPHA,
    SCI_GETADDITIONALSELECTIONTYPING, SCI_GETANCHOR, SCI_GETBACKSPACEUNINDENTS,
    ...
    SCI_GETFIRSTVISIBLELINE, SCI_GETFOCUS, SCI_GETFONTQUALITY, SCI_GETGAPPOSITION,
    SCI_GETHIGHLIGHTGUIDE, SCI_GETHOTSPOTACTIVEBACK, SCI_GETHOTSPOTACTIVEFORE,
    ...
    SCI_GETINDICATORVALUE, SCI_GETLENGTH, SCI_GETLINE, SCI_GETLINECOUNT, SCI_GETLINEENDPOSITION,
    ...
    SCI_SETPRINTCOLOURMODE, SCI_SETPRINTMAGNIFICATION, SCI_SETPRINTWRAPMODE,
