...
pub use scintilla_sys::{
    ...
    SCI_GOTOPOS, SCI_GRABFOCUS, SCI_HIDESELECTION, SCI_INDICATORALLONFOR, SCI_INDICATORCLEARRANGE,
    SCI_INDICATOREND, SCI_INDICATORFILLRANGE, SCI_INDICATORSTART, SCI_INDICATORVALUEAT,
    SCI_INDICGETALPHA, SCI_INDICGETFLAGS, SCI_INDICGETFORE, SCI_INDICGETHOVERFORE,
    SCI_INDICGETHOVERSTYLE, SCI_INDICGETOUTLINEALPHA, SCI_INDICGETSTYLE, SCI_INDICGETUNDER,
    SCI_INDICSETALPHA, SCI_INDICSETFLAGS, SCI_INDICSETFORE, SCI_INDICSETHOVERFORE,
    SCI_INDICSETHOVERSTYLE, SCI_INDICSETOUTLINEALPHA, SCI_INDICSETSTYLE, SCI_INDICSETUNDER,
    ...
    SCI_STYLEGETBOLD, SCI_STYLEGETCASE, SCI_STYLEGETCHANGEABLE, SCI_STYLEGETCHARACTERSET,
    ...
    SCI_STYLESETBOLD, SCI_STYLESETCASE, SCI_STYLESETCHANGEABLE, SCI_STYLESETCHARACTERSET,
