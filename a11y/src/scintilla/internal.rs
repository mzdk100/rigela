...
pub use scintilla_sys::{
    ...
    CARET_STRICT, INDIC0_MASK, INDIC1_MASK, INDIC2_MASK, INDICS_MASK, SCFIND_CXX11REGEX,
    SCFIND_MATCHCASE, SCFIND_POSIX, SCFIND_REGEXP, SCFIND_WHOLEWORD, SCFIND_WORDSTART,
    SCI_ADDSELECTION, SCI_ADDSTYLEDTEXT, SCI_ADDTABSTOP, SCI_ADDTEXT, SCI_ADDUNDOACTION,
    SCI_ALLOCATE, SCI_ALLOCATEEXTENDEDSTYLES, SCI_ANNOTATIONCLEARALL, SCI_ANNOTATIONGETLINES,
    ...
    SCI_ANNOTATIONSETVISIBLE, SCI_APPENDTEXT, SCI_ASSIGNCMDKEY, SCI_AUTOCACTIVE, SCI_AUTOCCANCEL,
    SCI_AUTOCCOMPLETE, SCI_AUTOCGETAUTOHIDE, SCI_AUTOCGETCANCELATSTART,
    SCI_AUTOCGETCASEINSENSITIVEBEHAVIOUR, SCI_AUTOCGETCHOOSESINGLE, SCI_AUTOCGETCURRENT,
    SCI_AUTOCGETCURRENTTEXT, SCI_AUTOCGETDROPRESTOFWORD, SCI_AUTOCGETIGNORECASE,
    SCI_AUTOCGETMAXHEIGHT, SCI_AUTOCGETMAXWIDTH, SCI_AUTOCGETMULTI, SCI_AUTOCGETORDER,
    SCI_AUTOCGETSEPARATOR, SCI_AUTOCGETTYPESEPARATOR, SCI_AUTOCPOSSTART, SCI_AUTOCSELECT,
    SCI_AUTOCSETAUTOHIDE, SCI_AUTOCSETCANCELATSTART, SCI_AUTOCSETCASEINSENSITIVEBEHAVIOUR,
    SCI_AUTOCSETCHOOSESINGLE, SCI_AUTOCSETDROPRESTOFWORD, SCI_AUTOCSETFILLUPS,
    SCI_AUTOCSETIGNORECASE, SCI_AUTOCSETMAXHEIGHT, SCI_AUTOCSETMAXWIDTH, SCI_AUTOCSETMULTI,
    SCI_AUTOCSETORDER, SCI_AUTOCSETSEPARATOR, SCI_AUTOCSETTYPESEPARATOR, SCI_AUTOCSHOW,
    SCI_AUTOCSTOPS, SCI_BACKTAB, SCI_BEGINUNDOACTION, SCI_BRACEBADLIGHT,
    ...
    SCI_CANREDO, SCI_CANUNDO, SCI_CHANGEINSERTION, SCI_CHARLEFT, SCI_CHARLEFTEXTEND,
    SCI_CHARLEFTRECTEXTEND, SCI_CHARRIGHT, SCI_CHARRIGHTEXTEND, SCI_CHARRIGHTRECTEXTEND,
    SCI_CHOOSECARETX, SCI_CLEAR, SCI_CLEARALL, SCI_CLEARALLCMDKEYS, SCI_CLEARCMDKEY,
    SCI_CLEARDOCUMENTSTYLE, SCI_CLEARREGISTEREDIMAGES, SCI_CLEARREPRESENTATION,
    SCI_CLEARSELECTIONS, SCI_CLEARTABSTOPS, SCI_CONVERTEOLS, SCI_COPY, SCI_COPYALLOWLINE,
    SCI_COPYRANGE, SCI_COPYTEXT, SCI_COUNTCHARACTERS, SCI_CUT, SCI_DELETEBACK,
    SCI_DELETEBACKNOTLINE, SCI_DELETERANGE, SCI_DELLINELEFT, SCI_DELLINERIGHT, SCI_DELWORDLEFT,
    SCI_DELWORDRIGHT, SCI_DELWORDRIGHTEND, SCI_DOCUMENTEND, SCI_DOCUMENTENDEXTEND,
    SCI_DOCUMENTSTART, SCI_DOCUMENTSTARTEXTEND, SCI_DROPSELECTIONN, SCI_EDITTOGGLEOVERTYPE,
    ...
    SCI_FORMATRANGE, SCI_FORMFEED, SCI_GETADDITIONALCARETFORE, SCI_GETADDITIONALCARETSBLINK,
    ...
    SCI_GETCARETSTYLE, SCI_GETCARETWIDTH, SCI_GETCHARACTERPOINTER, SCI_GETCHARAT, SCI_GETCODEPAGE,
    SCI_GETCOLUMN, SCI_GETCONTROLCHARSYMBOL, SCI_GETCURLINE, SCI_GETCURRENTPOS, SCI_GETCURSOR,
    SCI_GETDIRECTFUNCTION, SCI_GETDIRECTPOINTER, SCI_GETENDATLASTLINE, SCI_GETENDSTYLED,
    SCI_GETEOLMODE, SCI_GETEXTRAASCENT, SCI_GETEXTRADESCENT, SCI_GETFIRSTVISIBLELINE, SCI_GETFOCUS,
    SCI_GETFONTQUALITY, SCI_GETGAPPOSITION, SCI_GETHIGHLIGHTGUIDE, SCI_GETHOTSPOTACTIVEBACK,
    SCI_GETHOTSPOTACTIVEFORE, SCI_GETHOTSPOTACTIVEUNDERLINE, SCI_GETHOTSPOTSINGLELINE,
    SCI_GETHSCROLLBAR, SCI_GETIDLESTYLING, SCI_GETIMEINTERACTION, SCI_GETINDENT,
    SCI_GETINDENTATIONGUIDES, SCI_GETINDICATORCURRENT, SCI_GETINDICATORVALUE, SCI_GETLENGTH,
    SCI_GETLINE, SCI_GETLINECOUNT, SCI_GETLINEENDPOSITION, SCI_GETLINEENDTYPESACTIVE,
    SCI_GETLINEENDTYPESALLOWED, SCI_GETLINEENDTYPESSUPPORTED, SCI_GETLINEINDENTATION,
    SCI_GETLINEINDENTPOSITION, SCI_GETLINESELENDPOSITION, SCI_GETLINESELSTARTPOSITION,
    SCI_GETLINESTATE, SCI_GETMAINSELECTION, SCI_GETMARGINBACKN, SCI_GETMARGINCURSORN,
    SCI_GETMARGINLEFT, SCI_GETMARGINMASKN, SCI_GETMARGINOPTIONS, SCI_GETMARGINRIGHT,
    SCI_GETMARGINS, SCI_GETMARGINSENSITIVEN, SCI_GETMARGINTYPEN, SCI_GETMARGINWIDTHN,
    SCI_GETMAXLINESTATE, SCI_GETMODIFY, SCI_GETMOUSEDOWNCAPTURES,
    ...
    SCI_GETPASTECONVERTENDINGS, SCI_GETPHASESDRAW, SCI_GETPRINTCOLOURMODE,
    SCI_GETPRINTMAGNIFICATION, SCI_GETPRINTWRAPMODE, SCI_GETPUNCTUATIONCHARS, SCI_GETRANGEPOINTER,
    ...
    SCI_GETREPRESENTATION, SCI_GETSCROLLWIDTH, SCI_GETSCROLLWIDTHTRACKING, SCI_GETSEARCHFLAGS,
    SCI_GETSELALPHA, SCI_GETSELECTIONEMPTY, SCI_GETSELECTIONEND, SCI_GETSELECTIONMODE,
    SCI_GETSELECTIONNANCHOR, SCI_GETSELECTIONNANCHORVIRTUALSPACE, SCI_GETSELECTIONNCARET,
    ...
    SCI_GETSTYLEAT, SCI_GETSTYLEDTEXT, SCI_GETTABDRAWMODE, SCI_GETTABINDENTS, SCI_GETTABWIDTH,
    SCI_GETTAG, SCI_GETTARGETEND, SCI_GETTARGETSTART, SCI_GETTARGETTEXT, SCI_GETTECHNOLOGY,
    SCI_GETTEXT, SCI_GETTEXTLENGTH, SCI_GETTEXTRANGE, SCI_GETUNDOCOLLECTION, SCI_GETUSETABS,
    ...
    SCI_GOTOPOS, SCI_GRABFOCUS, SCI_HIDESELECTION, SCI_HOME, SCI_HOMEDISPLAY,
    ...
    SCI_LINESCROLL, SCI_LINESCROLLDOWN, SCI_LINESCROLLUP, SCI_LINESONSCREEN, SCI_LINETRANSPOSE,
    SCI_LINEUP, SCI_LINEUPEXTEND, SCI_LINEUPRECTEXTEND, SCI_LOWERCASE, SCI_MARGINGETSTYLE,
    ...
    SCI_MOVESELECTEDLINESUP, SCI_MULTIPLESELECTADDEACH, SCI_MULTIPLESELECTADDNEXT, SCI_NEWLINE,
    SCI_NULL, SCI_PAGEDOWN, SCI_PAGEDOWNEXTEND, SCI_PAGEDOWNRECTEXTEND, SCI_PAGEUP,
    ...
    SCI_REDO, SCI_REGISTERIMAGE, SCI_REGISTERRGBAIMAGE, SCI_RELEASEALLEXTENDEDSTYLES,
    SCI_REPLACESEL, SCI_REPLACETARGET, SCI_REPLACETARGETRE, SCI_RGBAIMAGESETHEIGHT,
    SCI_RGBAIMAGESETSCALE, SCI_RGBAIMAGESETWIDTH, SCI_ROTATESELECTION, SCI_SCROLLCARET,
    SCI_SCROLLRANGE, SCI_SCROLLTOEND, SCI_SCROLLTOSTART, SCI_SEARCHANCHOR, SCI_SEARCHINTARGET,
    SCI_SEARCHNEXT, SCI_SEARCHPREV, SCI_SELECTALL, SCI_SELECTIONDUPLICATE,
    SCI_SELECTIONISRECTANGLE, SCI_SETADDITIONALCARETFORE, SCI_SETADDITIONALCARETSBLINK,
    ...
    SCI_SETBACKSPACEUNINDENTS, SCI_SETBIDIRECTIONAL, SCI_SETBUFFEREDDRAW, SCI_SETCARETFORE,
    SCI_SETCARETLINEBACK, SCI_SETCARETLINEBACKALPHA, SCI_SETCARETLINEFRAME,
    ...
    SCI_SETPASTECONVERTENDINGS, SCI_SETPHASESDRAW, SCI_SETPRINTCOLOURMODE,
    SCI_SETPRINTMAGNIFICATION, SCI_SETPRINTWRAPMODE, SCI_SETPUNCTUATIONCHARS, SCI_SETREADONLY,
    ...
    SCI_SETXOFFSET, SCI_SETYCARETPOLICY, SCI_STARTRECORD, SCI_STARTSTYLING, SCI_STOPRECORD,
    ...
    SCI_SWAPMAINANCHORCARET, SCI_TAB, SCI_TARGETASUTF8, SCI_TARGETFROMSELECTION,
    SCI_TARGETWHOLEDOCUMENT, SCI_TEXTHEIGHT, SCI_TEXTWIDTH, SCI_TOGGLECARETSTICKY, SCI_UNDO,
    SCI_UPPERCASE, SCI_USEPOPUP, SCI_USERLISTSHOW, SCI_VCHOME, SCI_VCHOMEDISPLAY,
    SCI_VCHOMEDISPLAYEXTEND, SCI_VCHOMEEXTEND, SCI_VCHOMERECTEXTEND, SCI_VCHOMEWRAP,
    SCI_VCHOMEWRAPEXTEND, SCI_VERTICALCENTRECARET, SCI_WORDENDPOSITION, SCI_WORDLEFT,
    ...
    SCMOD_ALT, SCMOD_CTRL, SCMOD_META, SCMOD_NORM, SCMOD_SHIFT, SCMOD_SUPER, SCVS_NONE,
    SCVS_NOWRAPLINESTART, SCVS_RECTANGULARSELECTION, SCVS_USERACCESSIBLE,
    SC_CASEINSENSITIVEBEHAVIOUR_IGNORECASE, SC_CASEINSENSITIVEBEHAVIOUR_RESPECTCASE, SC_CP_UTF8,
    SC_CURSORARROW, SC_CURSORNORMAL, SC_CURSORREVERSEARROW, SC_CURSORWAIT,
    SC_EFF_QUALITY_ANTIALIASED, SC_EFF_QUALITY_DEFAULT, SC_EFF_QUALITY_LCD_OPTIMIZED,
    SC_EFF_QUALITY_MASK, SC_EFF_QUALITY_NON_ANTIALIASED, SC_INDICFLAG_VALUEFORE, SC_INDICVALUEMASK,
