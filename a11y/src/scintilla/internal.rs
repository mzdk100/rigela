...
use scintilla_sys::{Sci_CharacterRange, Sci_PositionCR, Sci_TextRange, Sci_TextToFind};
pub use scintilla_sys::{
    ...
    SCI_FORMFEED, SCI_GETADDITIONALCARETFORE, SCI_GETADDITIONALCARETSBLINK,
    ...
    SCI_GETENDATLASTLINE, SCI_GETENDSTYLED, SCI_GETEOLMODE, SCI_GETEXTRAASCENT,
    SCI_GETEXTRADESCENT, SCI_GETFIRSTVISIBLELINE, SCI_GETFOCUS, SCI_GETFONTQUALITY,
...
use crate::scintilla::popup::PopUpMode;
use crate::scintilla::{
