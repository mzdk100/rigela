...
pub use scintilla_sys::{
    ...
    SCI_ANNOTATIONSETTEXT, SCI_ANNOTATIONSETVISIBLE, SCI_APPENDTEXT, SCI_BEGINUNDOACTION,
    ...
    SCI_CLEAR, SCI_CLEARALL, SCI_CLEARDOCUMENTSTYLE, SCI_CLEARREPRESENTATION, SCI_CLEARSELECTIONS,
    ...
    SCI_GETANCHOR, SCI_GETBIDIRECTIONAL, SCI_GETBUFFEREDDRAW, SCI_GETCARETFORE,
    ...
    SCI_GETFIRSTVISIBLELINE, SCI_GETFOCUS, SCI_GETFONTQUALITY, SCI_GETHOTSPOTACTIVEBACK,
    SCI_GETHOTSPOTACTIVEFORE, SCI_GETHOTSPOTACTIVEUNDERLINE, SCI_GETHOTSPOTSINGLELINE,
    SCI_GETHSCROLLBAR, SCI_GETIDLESTYLING, SCI_GETIMEINTERACTION, SCI_GETLENGTH, SCI_GETLINE,
    ...
    SCI_GETPHASESDRAW, SCI_GETPUNCTUATIONCHARS, SCI_GETREADONLY, SCI_GETRECTANGULARSELECTIONANCHOR,
    ...
    SCI_GETSELECTIONNSTART, SCI_GETSELECTIONS, SCI_GETSELEOLFILLED, SCI_GETSELTEXT, SCI_GETSTATUS,
    SCI_GETSTYLEAT, SCI_GETSTYLEDTEXT, SCI_GETTABDRAWMODE, SCI_GETTAG, SCI_GETTARGETEND,
    SCI_GETTARGETSTART, SCI_GETTARGETTEXT, SCI_GETTECHNOLOGY, SCI_GETTEXT, SCI_GETTEXTLENGTH,
    SCI_GETTEXTRANGE, SCI_GETUNDOCOLLECTION, SCI_GETVIEWEOL, SCI_GETVIEWWS,
    SCI_GETVIRTUALSPACEOPTIONS, SCI_GETVSCROLLBAR, SCI_GETWHITESPACECHARS, SCI_GETWHITESPACESIZE,
    SCI_GETWORDCHARS, SCI_GETXOFFSET, SCI_GOTOLINE, SCI_GOTOPOS, SCI_GRABFOCUS, SCI_HIDESELECTION,
    SCI_INSERTTEXT, SCI_ISRANGEWORD, SCI_LINEFROMPOSITION, SCI_LINELENGTH, SCI_LINESCROLL,
    SCI_LINESONSCREEN, SCI_MARGINGETSTYLE, SCI_MARGINGETSTYLEOFFSET, SCI_MARGINGETSTYLES,
    SCI_MARGINGETTEXT, SCI_MARGINSETSTYLE, SCI_MARGINSETSTYLEOFFSET, SCI_MARGINSETSTYLES,
    SCI_MARGINSETTEXT, SCI_MARGINTEXTCLEARALL, SCI_MOVECARETINSIDEVIEW, SCI_MOVESELECTEDLINESDOWN,
    ...
    SCI_SETADDITIONALSELFORE, SCI_SETANCHOR, SCI_SETBIDIRECTIONAL, SCI_SETBUFFEREDDRAW,
    ...
    SCI_SETHOTSPOTSINGLELINE, SCI_SETHSCROLLBAR, SCI_SETIDLESTYLING, SCI_SETIMEINTERACTION,
    SCI_SETLENGTHFORENCODE, SCI_SETLINEENDTYPESALLOWED, SCI_SETLINESTATE, SCI_SETMAINSELECTION,
    ...
    SCI_SETSTYLINGEX, SCI_SETTABDRAWMODE, SCI_SETTARGETEND, SCI_SETTARGETSTART, SCI_SETTECHNOLOGY,
    ...
    SCI_SETXOFFSET, SCI_SETYCARETPOLICY, SCI_STARTSTYLING, SCI_STYLECLEARALL, SCI_STYLEGETBACK,
