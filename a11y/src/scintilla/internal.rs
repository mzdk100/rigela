...
pub use scintilla_sys::{
    ...
    SCI_GETFIRSTVISIBLELINE, SCI_GETHOTSPOTACTIVEBACK, SCI_GETHOTSPOTACTIVEFORE,
    ...
    SCI_GETTARGETSTART, SCI_GETTARGETTEXT, SCI_GETTEXT, SCI_GETTEXTLENGTH, SCI_GETTEXTRANGE,
    SCI_GETUNDOCOLLECTION, SCI_GETVIEWEOL, SCI_GETVIEWWS, SCI_GETVIRTUALSPACEOPTIONS,
    SCI_GETVSCROLLBAR, SCI_GETWHITESPACECHARS, SCI_GETWHITESPACESIZE, SCI_GETWORDCHARS,
    SCI_GETXOFFSET, SCI_GOTOLINE, SCI_GOTOPOS, SCI_HIDESELECTION, SCI_INSERTTEXT, SCI_ISRANGEWORD,
    SCI_LINEFROMPOSITION, SCI_LINELENGTH, SCI_LINESCROLL, SCI_LINESONSCREEN, SCI_MARGINGETSTYLE,
