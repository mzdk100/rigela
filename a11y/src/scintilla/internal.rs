...
pub use scintilla_sys::{
    ...
    SCI_GETLASTCHILD, SCI_GETLAYOUTCACHE, SCI_GETLENGTH, SCI_GETLINE, SCI_GETLINECOUNT,
    SCI_GETLINEENDPOSITION, SCI_GETLINEENDTYPESACTIVE, SCI_GETLINEENDTYPESALLOWED,
    SCI_GETLINEENDTYPESSUPPORTED, SCI_GETLINEINDENTATION, SCI_GETLINEINDENTPOSITION,
    SCI_GETLINESELENDPOSITION, SCI_GETLINESELSTARTPOSITION, SCI_GETLINESTATE, SCI_GETLINEVISIBLE,
    SCI_GETMAINSELECTION, SCI_GETMARGINBACKN, SCI_GETMARGINCURSORN, SCI_GETMARGINLEFT,
    SCI_GETMARGINMASKN, SCI_GETMARGINOPTIONS, SCI_GETMARGINRIGHT, SCI_GETMARGINS,
    SCI_GETMARGINSENSITIVEN, SCI_GETMARGINTYPEN, SCI_GETMARGINWIDTHN, SCI_GETMAXLINESTATE,
    ...
    SCI_GETMULTIPLESELECTION, SCI_GETNEXTTABSTOP, SCI_GETOVERTYPE, SCI_GETPASTECONVERTENDINGS,
    SCI_GETPHASESDRAW, SCI_GETPOSITIONCACHE, SCI_GETPRINTCOLOURMODE, SCI_GETPRINTMAGNIFICATION,
    SCI_GETPRINTWRAPMODE, SCI_GETPUNCTUATIONCHARS, SCI_GETRANGEPOINTER, SCI_GETREADONLY,
    ...
    SCI_MULTIPLESELECTADDNEXT, SCI_NEWLINE, SCI_NULL, SCI_PAGEDOWN, SCI_PAGEDOWNEXTEND,
    SCI_PAGEDOWNRECTEXTEND, SCI_PAGEUP, SCI_PAGEUPEXTEND, SCI_PAGEUPRECTEXTEND, SCI_PARADOWN,
    SCI_PARADOWNEXTEND, SCI_PARAUP, SCI_PARAUPEXTEND, SCI_PASTE, SCI_POINTXFROMPOSITION,
    SCI_POINTYFROMPOSITION, SCI_POSITIONAFTER, SCI_POSITIONBEFORE, SCI_POSITIONFROMPOINT,
    SCI_POSITIONFROMPOINTCLOSE, SCI_POSITIONRELATIVE, SCI_REDO, SCI_REGISTERIMAGE,
    ...
    SCI_SELECTALL, SCI_SELECTIONDUPLICATE, SCI_SELECTIONISRECTANGLE, SCI_SETADDITIONALCARETFORE,
    ...
    SCI_SETANCHOR, SCI_SETAUTOMATICFOLD, SCI_SETBACKSPACEUNINDENTS, SCI_SETBIDIRECTIONAL,
    ...
    SCI_SETCURSOR, SCI_SETDOCPOINTER, SCI_SETEMPTYSELECTION, SCI_SETENDATLASTLINE, SCI_SETEOLMODE,
    ...
    SCI_SETINDENTATIONGUIDES, SCI_SETINDICATORCURRENT, SCI_SETINDICATORVALUE, SCI_SETLAYOUTCACHE,
    ...
    SCI_SETPOSITIONCACHE, SCI_SETPRINTCOLOURMODE, SCI_SETPRINTMAGNIFICATION, SCI_SETPRINTWRAPMODE,
