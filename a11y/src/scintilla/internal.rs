...
pub use scintilla_sys::{
    ...
    SCI_ADDREFDOCUMENT, SCI_ADDSELECTION, SCI_ADDSTYLEDTEXT, SCI_ADDTABSTOP, SCI_ADDTEXT,
    SCI_ADDUNDOACTION, SCI_ALLOCATE, SCI_ALLOCATEEXTENDEDSTYLES, SCI_ANNOTATIONCLEARALL,
    SCI_ANNOTATIONGETLINES, SCI_ANNOTATIONGETSTYLE, SCI_ANNOTATIONGETSTYLEOFFSET,
    SCI_ANNOTATIONGETSTYLES, SCI_ANNOTATIONGETTEXT, SCI_ANNOTATIONGETVISIBLE,
    SCI_ANNOTATIONSETSTYLE, SCI_ANNOTATIONSETSTYLEOFFSET, SCI_ANNOTATIONSETSTYLES,
    SCI_ANNOTATIONSETTEXT, SCI_ANNOTATIONSETVISIBLE, SCI_APPENDTEXT, SCI_ASSIGNCMDKEY,
    SCI_AUTOCACTIVE, SCI_AUTOCCANCEL, SCI_AUTOCCOMPLETE, SCI_AUTOCGETAUTOHIDE,
    ...
    SCI_CLEARSELECTIONS, SCI_CLEARTABSTOPS, SCI_CONTRACTEDFOLDNEXT, SCI_CONVERTEOLS, SCI_COPY,
    SCI_COPYALLOWLINE, SCI_COPYRANGE, SCI_COPYTEXT, SCI_COUNTCHARACTERS, SCI_CREATEDOCUMENT,
    SCI_CREATELOADER, SCI_CUT, SCI_DELETEBACK, SCI_DELETEBACKNOTLINE, SCI_DELETERANGE,
    SCI_DELLINELEFT, SCI_DELLINERIGHT, SCI_DELWORDLEFT, SCI_DELWORDRIGHT, SCI_DELWORDRIGHTEND,
    SCI_DOCUMENTEND, SCI_DOCUMENTENDEXTEND, SCI_DOCUMENTSTART, SCI_DOCUMENTSTARTEXTEND,
    SCI_DROPSELECTIONN, SCI_EDITTOGGLEOVERTYPE, SCI_EMPTYUNDOBUFFER, SCI_ENCODEDFROMUTF8,
    SCI_ENDUNDOACTION, SCI_ENSUREVISIBLE, SCI_ENSUREVISIBLEENFORCEPOLICY, SCI_EXPANDCHILDREN,
    SCI_FINDCOLUMN, SCI_FINDINDICATORFLASH, SCI_FINDINDICATORHIDE, SCI_FINDINDICATORSHOW,
    SCI_FINDTEXT, SCI_FOLDALL, SCI_FOLDCHILDREN, SCI_FOLDDISPLAYTEXTSETSTYLE, SCI_FOLDLINE,
    ...
    SCI_GETDIRECTFUNCTION, SCI_GETDIRECTPOINTER, SCI_GETDOCPOINTER, SCI_GETENDATLASTLINE,
    SCI_GETENDSTYLED, SCI_GETEOLMODE, SCI_GETEXTRAASCENT, SCI_GETEXTRADESCENT,
    SCI_GETFIRSTVISIBLELINE, SCI_GETFOCUS, SCI_GETFOLDEXPANDED, SCI_GETFOLDLEVEL,
    SCI_GETFOLDPARENT, SCI_GETFONTQUALITY, SCI_GETGAPPOSITION, SCI_GETHIGHLIGHTGUIDE,
    ...
    SCI_GETINDENT, SCI_GETINDENTATIONGUIDES, SCI_GETINDICATORCURRENT, SCI_GETINDICATORVALUE,
    SCI_GETLASTCHILD, SCI_GETLENGTH, SCI_GETLINE, SCI_GETLINECOUNT, SCI_GETLINEENDPOSITION,
    ...
    SCI_GETMOVEEXTENDSSELECTION, SCI_GETMULTIPASTE, SCI_GETMULTIPLESELECTION, SCI_GETNEXTTABSTOP,
    SCI_GETOVERTYPE, SCI_GETPASTECONVERTENDINGS, SCI_GETPHASESDRAW, SCI_GETPRINTCOLOURMODE,
    ...
    SCI_GOTOPOS, SCI_GRABFOCUS, SCI_HIDELINES, SCI_HIDESELECTION, SCI_HOME, SCI_HOMEDISPLAY,
    ...
    SCI_RELEASEDOCUMENT, SCI_REPLACESEL, SCI_REPLACETARGET, SCI_REPLACETARGETRE,
    SCI_RGBAIMAGESETHEIGHT, SCI_RGBAIMAGESETSCALE, SCI_RGBAIMAGESETWIDTH, SCI_ROTATESELECTION,
    SCI_SCROLLCARET, SCI_SCROLLRANGE, SCI_SCROLLTOEND, SCI_SCROLLTOSTART, SCI_SEARCHANCHOR,
    SCI_SEARCHINTARGET, SCI_SEARCHNEXT, SCI_SEARCHPREV, SCI_SELECTALL, SCI_SELECTIONDUPLICATE,
    ...
    SCI_SETAUTOMATICFOLD, SCI_SETBACKSPACEUNINDENTS, SCI_SETBIDIRECTIONAL, SCI_SETBUFFEREDDRAW,
    ...
    SCI_SETCONTROLCHARSYMBOL, SCI_SETCURRENTPOS, SCI_SETCURSOR, SCI_SETDOCPOINTER,
    SCI_SETEMPTYSELECTION, SCI_SETENDATLASTLINE, SCI_SETEOLMODE, SCI_SETEXTRAASCENT,
    SCI_SETEXTRADESCENT, SCI_SETFIRSTVISIBLELINE, SCI_SETFOCUS, SCI_SETFOLDEXPANDED,
    SCI_SETFOLDFLAGS, SCI_SETFOLDLEVEL, SCI_SETFOLDMARGINCOLOUR, SCI_SETFOLDMARGINHICOLOUR,
    ...
    SCI_SETXOFFSET, SCI_SETYCARETPOLICY, SCI_SHOWLINES, SCI_STARTRECORD, SCI_STARTSTYLING,
    SCI_STOPRECORD, SCI_STUTTEREDPAGEDOWN, SCI_STUTTEREDPAGEDOWNEXTEND, SCI_STUTTEREDPAGEUP,
    ...
    SCI_WORDSTARTPOSITION, SCMOD_ALT, SCMOD_CTRL, SCMOD_META, SCMOD_NORM, SCMOD_SHIFT, SCMOD_SUPER,
    ...
    SC_EFF_QUALITY_MASK, SC_EFF_QUALITY_NON_ANTIALIASED, SC_FOLDFLAG_LEVELNUMBERS,
    SC_FOLDFLAG_LINEAFTER_CONTRACTED, SC_FOLDFLAG_LINEAFTER_EXPANDED,
